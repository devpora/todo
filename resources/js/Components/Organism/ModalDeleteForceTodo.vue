...
<template>
    <svg @click="showModal" color="red" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 hover:scale-125 hover:cursor-pointer">
    ...
    <FwbModal v-if="isShowModal" @close="closeModal">
        ...
        <template #footer>
            <div class="flex justify-between">
                ...
                <FwbButton :disabled="loading" @click="destroyTodo(todo.id)" color="red">
